...
@section('content')
		...
		<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92 bg-dark" style="background-image: url('public/frontend/images/bg-01.jpg');">
		<h2 class="ltext-105 cl0 txt-light">
			Shopping Cart
		</h2>
	</section>	
					...
					<div class="wrap-table-shopping-cart">
						<table class="table-shopping-cart">
							...
							<tr class="table_row">
								<td class="column-1">
									<div class="how-itemcart1">
										<img src="{{asset('public/frontend')}}/images/item-cart-04.jpg" alt="IMG">
									</div>
								</td>
							...
							<tr class="table_row">
								<td class="column-1">
									<div class="how-itemcart1">
										<img src="{{asset('public/frontend')}}/images/item-cart-05.jpg" alt="IMG">
									</div>
								</td>
